    ...
    <main className="flex-1">
      ...
      <section className="relative overflow-hidden pb-24 pt-36">
        ...
        <div className="relative mx-auto max-w-3xl px-6">
          ...
          <h1 className="mt-4 text-4xl font-bold tracking-tight text-zinc-900 md:text-5xl">Terms of service</h1>
          ...
          <div className="mt-12 flex flex-col items-start gap-4 rounded-2xl border border-amber-200 bg-gradient-to-br from-amber-50 to-transparent p-6">
            <p className="text-sm text-zinc-700">Questions about these terms?</p>
