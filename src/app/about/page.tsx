    ...
    <main className="flex-1">
      ...
      <section className="relative overflow-hidden pb-16 pt-36">
        <div className="pointer-events-none absolute inset-0">
          <div className="absolute left-1/2 top-0 h-[400px] w-[800px] -translate-x-1/2 rounded-full bg-amber-500/10 blur-[120px]" />
        </div>
        <div className="relative mx-auto max-w-3xl px-6 text-center">
          <div className="text-xs font-semibold uppercase tracking-widest text-amber-400">About WebForge</div>
      ...
      <section className="border-y border-white/5 bg-[#0b0b0e] py-14">
      ...
      <section className="py-24">
        <div className="mx-auto max-w-6xl px-6">
          <div className="mx-auto max-w-2xl text-center">
            <div className="text-xs font-semibold uppercase tracking-widest text-amber-400">Why WebForge</div>
            <h2 className="mt-3 text-4xl font-bold tracking-tight text-white md:text-5xl">What we believe</h2>
          </div>
          <div className="mt-14 grid gap-6 md:grid-cols-2">
            {values.map((v) => (
              <div
                key={v.title}
                className="rounded-2xl border border-white/5 bg-[#101014] p-8 transition-colors hover:border-amber-400/25"
              >
      ...
      <section className="border-y border-white/5 bg-[#0b0b0e] py-24">
        <div className="mx-auto max-w-6xl px-6">
          <div className="mx-auto max-w-2xl text-center">
            <div className="text-xs font-semibold uppercase tracking-widest text-amber-400">Process</div>
            <h2 className="mt-3 text-4xl font-bold tracking-tight text-white md:text-5xl">How it works</h2>
            <p className="mt-4 text-zinc-400">From template to live website in as little as 3 days.</p>
          </div>
          <div className="mt-14 grid gap-6 md:grid-cols-4">
            {process.map((s) => (
              <div key={s.step} className="rounded-2xl border border-white/5 bg-[#101014] p-7">
                <div className="text-xs font-semibold text-zinc-500">Step {s.step}</div>
                <div className="mt-4 flex h-11 w-11 items-center justify-center rounded-xl bg-amber-400/10 text-amber-400">
      ...
      <section className="py-24">
        <div className="mx-auto max-w-6xl px-6">
          <div className="mx-auto max-w-2xl text-center">
            <div className="text-xs font-semibold uppercase tracking-widest text-amber-400">The team</div>
            <h2 className="mt-3 text-4xl font-bold tracking-tight text-white md:text-5xl">Built by people who ship</h2>
          ...
          <div className="mt-10 flex flex-wrap items-center justify-center gap-4 text-sm text-zinc-400">
            <span className="rounded-full border border-white/10 bg-[#101014] px-4 py-2">Design</span>
            <span className="rounded-full border border-white/10 bg-[#101014] px-4 py-2">Development</span>
            <span className="rounded-full border border-white/10 bg-[#101014] px-4 py-2">SEO</span>
            <span className="rounded-full border border-white/10 bg-[#101014] px-4 py-2">Content</span>
            <span className="rounded-full border border-white/10 bg-[#101014] px-4 py-2">Support</span>
          </div>
